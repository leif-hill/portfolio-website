...
const LandingMobile = () => {
  ...
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 9000, overflow: 'auto', backgroundColor: 'transparent', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      <h1 className={`${kanit.className} text-white ml-5 text-3xl fade-in1`}>Hi, my name is Leif 👋</h1>
      <h2 className={`${kanit.className} fade-in1`} style={{ color: 'white', fontSize: '1rem', marginTop: '10px' }}>Let's get started!</h2>
