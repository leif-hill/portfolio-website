...
const PortfolioPage = () => {
  ...
  return (
    <div className="transition-colors duration-300" id="placeholder" style={{ backgroundColor: 'var(--background)', padding: '6rem', marginLeft: '8rem', marginRight: '8rem' }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', padding: '1rem', width: '100%' }}>
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
          <h1 className={`${kanit.className}`} style={{ fontSize: '3rem', color: 'var(--foreground)', textAlign: 'left', marginRight: '1rem' }}>
            Portfolio
          </h1>
          <div className="toggle-switch" onClick={toggleProjects} style={{ marginTop: '0.5rem' }}>
        ...
        <h1 className={`${kanit.className}`} style={{ fontSize: '1.5rem', color: 'var(--foreground)', textAlign: 'left' }}>
