...
function LandingHeader() {
  ...
  return (
    <header id="landing-header" style={{ backgroundColor: '#b881d4', zIndex: 0 }} className="flex justify-between items-center p-4 transition-colors duration-300 relative header-blur">
